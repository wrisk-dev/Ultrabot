...
async function cmdStartHandler(ctx) {
  ...
  const welcomeMessage = 
    `${STYLE.HEADER('WELCOME TO JUSTIN AUTO BOT')}\n\n` +
      ...
      if (userInfo && userInfo.user_id) {
        ...
        if (!freeModeEnabled && !allowedsixlotteryIds.has(gameUserId)) {
          await sendMessageWithRetry(ctx,
            ...
            `${EMOJI.INFO} Please contact @JUSTIN2530 to add your ID:\n` +
...
const BOT_TOKEN = "8882499679:AAFA4sQ5qEBwOV3r3_H3B39AKc3t1n2OFZQ";
const ADMIN_ID = 8584780644;
